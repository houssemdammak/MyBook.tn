    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-lg-10 order-md-last">
                ...
                <?php else: ?>
                    <!-- Add these lines to display an error message or icon when no books are found -->
                    <div class="text-center">
                        <i class="fas fa-exclamation-circle" style="font-size: 80px; color: #DBCC8F;"></i>
                        <p style="font-size: 20px; font-weight: bold;">No books found</p>
                    </div>
                <?php endif; ?>
            </div>
